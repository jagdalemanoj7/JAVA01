...
public class Tc_06 extends BaseClass{
	...
	//  click on User in Assign To user  create a new Opportunity for every User in the dropdown[Administrator]
					// ASSIGN TO USER BYDEFAULT SELECTED AS USER, ADMINISTRATOR....
